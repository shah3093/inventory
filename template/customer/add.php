                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" name="formdata[name]" required class="required form-control" id="category">
                            </div>
                        </div>
                        <div class="col-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" name="formdata[phones]"  class="form-control" id="category">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" name="formdata[voterid]"  class="form-control" id="category">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                <label for="category" class="bmd-label-floating">Facebook</label>
                                <input type="text" name="formdata[facebookid]"  class="form-control" id="category">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" name="formdata[note]"  class="form-control" id="category">
                            </div>
                        </div>
                    </div>
