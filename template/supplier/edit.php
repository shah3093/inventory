            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" value="<?php echo $supplier['shop_name']; ?>" name="formdata[shop_name]" required class="required form-control" id="category">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                <label for="category" class="bmd-label-floating">Provider</label>
                                <input value="<?php echo $supplier['provider']; ?>" type="text" name="formdata[provider]"  class=" form-control" id="category">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input type="text" value="<?php echo $supplier['email']; ?>" name="formdata[email]"  class="form-control" id="category">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                <label for="category" class="bmd-label-floating">Phone</label>
                                <input value="<?php echo $supplier['phone']; ?>" type="text" name="formdata[phone]"  class="form-control" id="category">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group bmd-form-group">
                        ...
                        <input value="<?php echo $supplier['bank_account_details']; ?>" type="text" name="formdata[bank_account_details]"  class="form-control" id="category">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group bmd-form-group">
                                ...
                                <input value="<?php echo $supplier['address']; ?>" type="text" name="formdata[address]"  class="form-control" id="category">
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="form-group bmd-form-group">
                        ...
                        <textarea name="formdata[note]"  class="form-control"><?php echo $supplier['address']; ?></textarea>
                    </div>
                    ...
                    <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new thumbnail" style="max-width: 150px !important;">
                              <?php if ($supplier['image'] != NULL): ?>
                                <img src="../assets/uploads/<?php echo $supplier['image']; ?>" alt="...">
                            <?php else : ?>
